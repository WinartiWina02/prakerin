			...
			<div class="row">
				<div class="col">
					<div class="header_content d-flex flex-row align-items-center justify-content-start">
						...
						<nav class="main_nav">
							<ul>
								<li class="active"><a href="categori">Home</a></li>
                                <li><a href="{{ url('categori')}} ">fashion</a></li>
								<li><a href="{{  url('categori') }}">Gadgets</a></li>
								<li><a href="{{ url('categori') }}">Lifestyle</a></li>
								<li><a href="{{ url('categori ') }}">Video</a></li>
								<li><a href={{ url('categori') }}>Contact</a></li>
							</ul>
						</nav>
	...
	<div class="menu d-flex flex-column align-items-end justify-content-start text-right menu_mm trans_400">
		...
		<nav class="menu_nav">
			<ul class="menu_mm">
				...
				<li class="menu_mm"><a href="fashion">Fashion</a></li>
				<li class="menu_mm"><a href="gadgets">Gadgets</a></li>
				<li class="menu_mm"><a href="lifestyle">Lifestyle</a></li>
				<li class="menu_mm"><a href="video">Video</a></li>
							...
							<div class="section_content">
								<div class="grid clearfix">
									...
									<div class="card card_default card_default_with_background grid-item">
										...
										<div class="card-body">
											<div class="card-title card-title-small"><a href="post">How Did van Gogh’s Turbulent Mind Depict One of the Most</a></div>
										</div>
									</div>
